    ...
    <nav className="container mx-auto pt-10 text-gray-400 flex justify-between items-center">
      <div className="flex py-2 justify-start items-center">
        ...
        <div className="flex gap-3 ps-5">
          <button className="btn btn-ghost rounded-full">Features</button>
          <button className="btn btn-ghost rounded-full">Pricing</button>
          <button className="btn btn-ghost rounded-full">Resources</button>
        </div>
      </div>
